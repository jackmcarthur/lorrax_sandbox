...
echo "=== gates (cohsex+gnppm) + unit suite after parser consolidation ==="
LORRAX_NGPU=1 lxrun python3 -m pytest -q tests/test_gw_jax_regression.py tests -m "not regression or regression" -o addopts="" 2>&1 | tail -12
