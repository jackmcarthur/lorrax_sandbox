...
echo "=== GN-PPM fixture v2 (full config), $(date) ==="
LORRAX_NGPU=1 JAX_TRACEBACK_FILTERING=off lxrun python3 -u -m gw.gw_jax -i cohsex_gnppm_test.in
echo "=== EXIT $? ==="
