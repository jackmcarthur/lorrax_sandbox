...
LORRAX_NGPU=1 lxrun python3 -m pytest -q tests/test_v_q_bispinor_helpers.py tests/test_per_q_sphere.py tests/test_compute_all_V_q_g_flat.py -o addopts="" -rA 2>&1 | tail -14
