# Round 2 — Agent 2: critique + revision

You finished round 1 and wrote `reports/zeta_rchunk_memory_model_2026-05-13/agent_2.md`. The other three agents wrote `agent_1.md`, `agent_3.md`, `agent_4.md` in the same directory, independently.

**Now read those three files.** Then write `reports/zeta_rchunk_memory_model_2026-05-13/agent_2_v2.md` containing the five sections below. Be terse where you can, exhaustive where you must.

## 1. Cross-reading notes

For each of the other three drafts (agent_1, agent_3, agent_4), 5–15 lines:
...
Cite by `agent_M.md §N` and your own `agent_2.md §N`.
...
- Read `agent_1.md`, `agent_3.md`, `agent_4.md` — those are the inputs to this round.
- Stop when `agent_2_v2.md` is written. Print "Agent 2 round 2 done".
