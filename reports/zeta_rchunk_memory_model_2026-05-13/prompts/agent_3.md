You are **Agent 3 of 4** in an independent multi-agent study of the LORRAX zeta-fit r-chunk memory model.

Three other agents (Agents 1, 2, 4) are working the same task in parallel tmux panes right now. You cannot see their work and they cannot see yours. After all four of you finish, the orchestrator will collect drafts and run a discussion round to surface what's missing.
...
`/pscratch/sd/j/jackm/lorrax_sandbox/reports/zeta_rchunk_memory_model_2026-05-13/agent_3.md`
...
- Do **not** read `agent_1.md`, `agent_2.md`, or `agent_4.md` in your report dir. Those belong to the other agents.
- Stay in this tmux pane.
- Stop when your file is written. Print a one-line summary: "Agent 3 done — see agent_3.md".
