# Round 2 — Agent 3: critique + revision

You finished round 1 and wrote `reports/zeta_rchunk_memory_model_2026-05-13/agent_3.md`. The other three agents wrote `agent_1.md`, `agent_2.md`, `agent_4.md` in the same directory, independently.

**Now read those three files.** Then write `reports/zeta_rchunk_memory_model_2026-05-13/agent_3_v2.md` containing the five sections below. Be terse where you can, exhaustive where you must.

## 1. Cross-reading notes

For each of the other three drafts (agent_1, agent_2, agent_4), 5–15 lines:
...
Cite by `agent_M.md §N` and your own `agent_3.md §N`.
...
- Read `agent_1.md`, `agent_2.md`, `agent_4.md` — those are the inputs to this round.
- Stop when `agent_3_v2.md` is written. Print "Agent 3 round 2 done".
