...
for i in 0 1 2 3; do
  agent=$((i + 1))
  cmd="claude --permission-mode bypassPermissions --model opus --effort high --name 'Agent ${agent}' 'Your assignment is at ${PROMPTS}/restart_agent_${agent}.md - read it and follow the instructions in it exactly.'"
