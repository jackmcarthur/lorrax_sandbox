...
# - Dataset axis orders in these specs follow FORTRAN conventions (column-major), i.e. reverse
#   of common Python row-major intuition when you map explicit index tuples.
# - Explicit mapping/index arrays (e.g. gind_eps2rho, gind_rho2eps, and related index lists)
#   are ONE-INDEXED in BerkeleyGW/Fortran conventions.
# - In Python/JAX/NumPy code, convert to zero-based indices explicitly and verify axis order before
#   transposes/einsum/index-gather operations.
# ==================================================================================================
