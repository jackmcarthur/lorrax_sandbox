#!/bin/bash
# Shifter launcher for the SMOOTH arbitrary-Q exciton bandstructure campaign.
# PYTHONPATH -> sources/worktrees/lorrax_bse_exciton_smooth/src
#   (agent/bse-exciton-smooth, branched from agent/bse-exciton-converged @ 86d9e6b)
#
...
SRC="${LX_SRC:-/pscratch/sd/j/jackm/lorrax_sandbox/sources/worktrees/lorrax_bse_exciton_smooth/src}"
