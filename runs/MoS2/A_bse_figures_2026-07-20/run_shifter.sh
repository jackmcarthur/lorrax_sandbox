#!/bin/bash
# Module-free srun+shifter runner for the BSE-figures run (PYTHONPATH ->
# lorrax_A_figures/src).  Mirrors skills/execute_workflow GWJAX steps 5-6 and
# 00_lorrax_cohsex/run_gw.sh (Lmod broken in scripts, KSE 2026-07-15).
...
SRC=/pscratch/sd/j/jackm/lorrax_sandbox/sources/worktrees/lorrax_A_figures/src
