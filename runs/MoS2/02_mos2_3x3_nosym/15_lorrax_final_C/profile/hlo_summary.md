...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/02_mos2_3x3_nosym/15_lorrax_final_C/profile/xla_dump`
**Modules dumped:** 469
**Sum of per-module peak live HBM:** 63.26 GiB (upper bound; peaks occur at different times)
...
| `module_0703.jit__identity_fn` | `all-gather-start` | 180.18 MiB | `` | `(c128[1,41,9,80,80]{4,3,2,1,0}, c128[4,41,9,80,80]{4,3,2,1,0` |
| `module_0723.jit__identity_fn` | `all-gather-start` | 180.18 MiB | `` | `(c128[1,41,9,80,80]{4,3,2,1,0}, c128[4,41,9,80,80]{4,3,2,1,0` |
...
|---|---:|---:|---:|
| `jit_broadcast_in_dim` | 69 | 1.76 GiB | 3.07 GiB |
...
| `jit_gather` | 21 | 112.50 MiB | 312.57 MiB |
| `jit_add` | 20 | 72.95 MiB | 574.16 MiB |
...
| `jit__accumulate_tau_into_window` | 8 | 39.55 MiB | 309.39 MiB |
| `jit_sqrt` | 8 | 14.06 MiB | 28.15 MiB |
| `jit_fft` | 6 | 126.56 MiB | 703.13 MiB |
| `jit__reduce_max` | 6 | 28.13 MiB | 70.35 MiB |
