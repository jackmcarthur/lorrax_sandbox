...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/02_mos2_3x3_nosym/63_zeta_profile_C/profile/xla_dump`
**Modules dumped:** 285
...
|---|---:|---|
| `module_0265.jit__single_chunk_proc` | 5.31 GiB | 3.52 GiB — preallocated-temp: |
...
| `module_0267.jit__unnamed_wrapped_function_` | 900.00 MiB | 450.00 MiB — output shape is \|c128[1,640,46080]\|, maybe-live-out: |
