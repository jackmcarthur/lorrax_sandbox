#!/bin/bash
# Shifter launcher for the converged-GW 8v8c exciton campaign.
# PYTHONPATH -> sources/worktrees/lorrax_bse_exciton_conv/src
#   (agent/bse-exciton-converged, branched from agent/gw-converged-campaign @ 5e50b8e)
#
...
SRC="${LX_SRC:-/pscratch/sd/j/jackm/lorrax_sandbox/sources/worktrees/lorrax_bse_exciton_conv/src}"
