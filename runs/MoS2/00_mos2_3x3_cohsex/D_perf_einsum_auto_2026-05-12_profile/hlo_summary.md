...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/00_mos2_3x3_cohsex/D_perf_einsum_auto_2026-05-12_profile/xla_dump`
**Modules dumped:** 879
**Sum of per-module peak live HBM:** 573.13 GiB (upper bound; peaks occur at different times)
...
| `module_0579.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0581.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0794.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0883.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0885.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_1080.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_1187.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_1189.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
...
| `module_0625.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0695.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0697.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0911.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0999.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1001.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1197.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1303.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
...
|---|---:|---:|---:|
| `jit__per_rank` | 114 | 1.01 GiB | 15.45 GiB |
| `jit_broadcast_in_dim` | 80 | 28.83 MiB | 296.77 MiB |
| `jit_convert_element_type` | 73 | 6.00 MiB | 21.34 MiB |
