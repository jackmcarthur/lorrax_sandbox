...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/00_mos2_3x3_cohsex/D_perf_take_auto_2026-05-12_profile/xla_dump`
**Modules dumped:** 878
**Sum of per-module peak live HBM:** 571.25 GiB (upper bound; peaks occur at different times)
...
| `module_0587.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0589.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0810.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0915.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_0917.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_1112.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_1243.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
| `module_1245.jit__kernel` | 21.76 GiB | 21.45 GiB — preallocated-temp: |
...
| `module_0633.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0711.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0713.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_0935.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1039.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1041.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1237.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
| `module_1367.jit__kernel` | 17.41 GiB | 17.15 GiB — preallocated-temp: |
...
|---|---:|---:|---:|
| `jit__per_rank` | 113 | 1.01 GiB | 15.40 GiB |
