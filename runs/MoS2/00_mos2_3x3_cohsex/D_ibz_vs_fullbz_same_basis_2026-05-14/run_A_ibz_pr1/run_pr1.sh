#!/usr/bin/env bash
# R1 — PR1 verification: same-basis IBZ cascade-ACTIVE run on commit 5da9ec7.
set -euo pipefail

SBOX=/pscratch/sd/j/jackm/lorrax_sandbox
RUN_DIR=$SBOX/runs/MoS2/00_mos2_3x3_cohsex/D_ibz_vs_fullbz_same_basis_2026-05-14/run_A_ibz_pr1
...
echo "[run] launching gw.gw_jax (R1 PR1) at $(date)"
LORRAX_NNODES=1 LORRAX_NGPU=1 lxrun \
