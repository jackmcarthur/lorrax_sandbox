...
export SLURM_JOBID=55396549
cd /pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/00_mos2_3x3_cohsex/02_lorrax_cohsex_noavg
echo "=== LORRAX noavg overlay, jid $SLURM_JOBID, src $LORRAX_SRC, $(date) ==="
