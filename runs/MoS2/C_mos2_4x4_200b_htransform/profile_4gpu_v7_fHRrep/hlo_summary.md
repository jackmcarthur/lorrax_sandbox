...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/C_mos2_4x4_200b_htransform/profile_4gpu_v7_fHRrep/xla_dump`
**Modules dumped:** 86
...
| `module_0185.jit__kpath_batch` | `all-gather-start` | 562.50 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:656` | `(c128[960,960,8]{1,0,2}, c128[960,960,32]{1,0,2})` |
...
| `module_0187.jit__post_kpath` | `all-to-all` | 360.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:707` | `f64[4,48,240]{2,1,0}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:707` | `f64[8,4,240]{2,0,1}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:707` | `f64[8,4,240]{2,0,1}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:707` | `f64[8,4,240]{2,0,1}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:707` | `f64[8,4,240]{2,0,1}` |
