...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/C_mos2_4x4_200b_htransform/profile_4gpu_v6_kpathshard/xla_dump`
**Modules dumped:** 85
**Sum of per-module peak live HBM:** 8.90 GiB (upper bound; peaks occur at different times)
...
| `module_0183.jit__kpath_batch` | 1.40 GiB | 1.33 GiB — preallocated-temp: |
...
| `module_0163.jit_subtract` | 116.02 MiB | 56.25 MiB — output shape is \|c128[16,480,480]\|, maybe-live-out: |
| `module_0143.jit__diag_stats` | 84.40 MiB | 56.25 MiB — parameter 0, shape \|c128[16,480,480]\| at ShapeIndex {}: |
| `module_0165.jit_abs` | 84.38 MiB | 56.25 MiB — parameter 0, shape \|c128[16,480,480]\| at ShapeIndex {}: |
| `module_0161.jit__gamma_rt` | 66.80 MiB | 56.25 MiB — parameter 0, shape \|c128[16,480,480]\| at ShapeIndex {}: |
...
| `module_0167.jit__reduce_max` | 28.16 MiB | 28.12 MiB — parameter 0, shape \|f64[16,480,480]\| at ShapeIndex {}: |
...
| `module_0079.jit_transpose` | 28.12 MiB | 14.06 MiB — output shape is \|c128[960,960]\|, maybe-live-out: |
...
| `module_0183.jit__kpath_batch` | `all-gather-start` | 562.50 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:659` | `(c128[960,960,8]{1,0,2}, c128[960,960,32]{1,0,2})` |
...
| `module_0183.jit__kpath_batch` | `all-gather-start` | 337.50 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:652` | `(c128[16,480,960]{2,0,1}, c128[16,960,960]{2,0,1})` |
| `module_0183.jit__kpath_batch` | `all-gather-start` | 168.75 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:652` | `(c128[16,480,480]{1,0,2}, c128[16,480,960]{1,0,2})` |
...
| `module_0185.jit__post_kpath` | `all-gather-start` | 1.79 MiB | `` | `((f64[46,960]{1,0}, f64[46,60]{1,0}), (f64[184,960]{1,0}, f6` |
| `module_0185.jit__post_kpath` | `all-to-all` | 360.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:710` | `f64[4,48,240]{2,1,0}` |
| `module_0185.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:710` | `f64[8,4,240]{2,0,1}` |
| `module_0185.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:710` | `f64[8,4,240]{2,0,1}` |
| `module_0185.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:710` | `f64[8,4,240]{2,0,1}` |
| `module_0185.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:710` | `f64[8,4,240]{2,0,1}` |
...
| `jit_subtract` | 4 | 116.02 MiB | 118.68 MiB |
