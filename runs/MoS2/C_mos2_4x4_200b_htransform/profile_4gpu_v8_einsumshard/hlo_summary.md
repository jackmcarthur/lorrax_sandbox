...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/MoS2/C_mos2_4x4_200b_htransform/profile_4gpu_v8_einsumshard/xla_dump`
**Modules dumped:** 86
**Sum of per-module peak live HBM:** 9.87 GiB (upper bound; peaks occur at different times)
...
| `module_0185.jit__kpath_batch` | 1.57 GiB | 1.33 GiB — preallocated-temp: |
...
| `module_0157.jit__identity_fn` | 618.75 MiB | 337.50 MiB — preallocated-temp: |
| `module_0163.jit__gamma_rt` | 253.13 MiB | 225.00 MiB — parameter 0, shape \|c128[16,960,960]\| at ShapeIndex {}: |
| `module_0135.jit__build_fH` | 182.82 MiB | 56.25 MiB — preallocated-temp: |
| `module_0165.jit_subtract` | 126.56 MiB | 56.25 MiB — output shape is \|c128[16,480,480]\|, maybe-live-out: |
| `module_0143.jit__diag_stats` | 84.40 MiB | 56.25 MiB — parameter 0, shape \|c128[16,480,480]\| at ShapeIndex {}: |
| `module_0167.jit_abs` | 84.38 MiB | 56.25 MiB — parameter 0, shape \|c128[16,480,480]\| at ShapeIndex {}: |
...
| `module_0169.jit__reduce_max` | 28.16 MiB | 28.12 MiB — parameter 0, shape \|f64[16,480,480]\| at ShapeIndex {}: |
...
| `module_0077.jit_conjugate` | 28.12 MiB | 14.06 MiB — output shape is \|c128[960,960]\|, maybe-live-out: |
...
| `module_0185.jit__kpath_batch` | `all-gather-start` | 562.50 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:666` | `(c128[960,960,8]{1,0,2}, c128[960,960,32]{1,0,2})` |
...
| `module_0157.jit__identity_fn` | `all-gather-start` | 337.50 MiB | `` | `(c128[16,480,960]{2,0,1}, c128[16,960,960]{2,0,1})` |
| `module_0157.jit__identity_fn` | `all-gather-start` | 168.75 MiB | `` | `(c128[16,480,480]{1,0,2}, c128[16,480,960]{1,0,2})` |
...
| `module_0143.jit__diag_stats` | `all-gather-start` | 21.09 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:607` | `(c128[480,960]{1,0}, c128[960,960]{1,0})` |
...
| `module_0143.jit__diag_stats` | `all-gather-start` | 10.55 MiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:607` | `(c128[480,480]{0,1}, c128[480,960]{0,1})` |
...
| `module_0187.jit__post_kpath` | `all-gather-start` | 1.79 MiB | `` | `((f64[46,960]{1,0}, f64[46,60]{1,0}), (f64[184,960]{1,0}, f6` |
| `module_0187.jit__post_kpath` | `all-to-all` | 360.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:717` | `f64[4,48,240]{2,1,0}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:717` | `f64[8,4,240]{2,0,1}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:717` | `f64[8,4,240]{2,0,1}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:717` | `f64[8,4,240]{2,0,1}` |
| `module_0187.jit__post_kpath` | `all-to-all` | 60.00 KiB | `/global/homes/j/jackm/software/lorrax_C/src/bandstructure/htransform.py:717` | `f64[8,4,240]{2,0,1}` |
...
|---|---:|---:|---:|
| `jit_broadcast_in_dim` | 12 | 14.06 MiB | 42.22 MiB |
...
| `jit__identity_fn` | 3 | 618.75 MiB | 646.88 MiB |
...
| `jit_gather` | 2 | 7.54 KiB | 8.05 KiB |
