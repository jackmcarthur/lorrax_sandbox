#!/bin/bash -l
# Agent N Round-7 faithfulness audit launcher.
# Usage: _launch_agent_n.sh <sandbox_dir> <slurm_jobid> <out_file>
set -u
...
# Probes & limits: zeta-only verification, 3 r-chunks, full BZ
