...
WFN='runs/CrI3/C_FM_prod_bispinor_2026-06-16/qe/nscf/WFN.h5'
...
for run,label in [('runs/CrI3/C_FM_prod_bispinor_2026-06-16/run2_fullbz','FULL-BZ-FIT'),
                  ('runs/CrI3/C_FM_prod_bispinor_2026-06-16/run1_ibz','IBZ-UNFOLD')]:
    V=load_tiles(run)
    print("\n"+"#"*80); print(f"# {label}")
...
Vf=load_tiles('runs/CrI3/C_FM_prod_bispinor_2026-06-16/run2_fullbz')
Vi=load_tiles('runs/CrI3/C_FM_prod_bispinor_2026-06-16/run1_ibz')
