...
**Dump dir:** `/pscratch/sd/j/jackm/lorrax_sandbox/runs/Si/04_si_4x4x4_bse/01_lorrax_bse_vcoul/profile_bse/xla_dump`
**Modules dumped:** 62
**Sum of per-module peak live HBM:** 3.66 GiB (upper bound; peaks occur at different times)
...
|---|---:|---|
| `module_0073.jit_scan` | 2.02 GiB | 1.78 GiB — preallocated-temp: |
...
| `module_0129.jit_matmul` | 6.72 MiB | 3.25 MiB — preallocated-temp: |
| `module_0067.jit_scatter` | 6.28 MiB | 3.12 MiB — output shape is \|c128[1024,200]\|, maybe-live-out: |
| `module_0059.jit_broadcast_in_dim` | 3.13 MiB | 0.00 B —  |
| `module_0103.jit_eigh` | 939.21 KiB | 312.60 KiB — preallocated-temp: |
| `module_0099.jit_add` | 937.50 KiB | 312.50 KiB — output shape is \|f64[200,200]\|, maybe-live-out: |
| `module_0137.jit_true_divide` | 640.16 KiB | 320.00 KiB — output shape is \|c128[20,1024]\|, maybe-live-out: |
| `module_0131.jit_transpose` | 640.00 KiB | 320.00 KiB — output shape is \|c128[20,1024]\|, maybe-live-out: |
| `module_0139.jit_reshape` | 640.00 KiB | 320.00 KiB — output shape is \|c128[20,4,4,64]\|, maybe-live-out: |
| `module_0125.jit_gather` | 343.83 KiB | 312.50 KiB — parameter 0, shape \|f64[200,200]\| at ShapeIndex {}: |
| `module_0133.jit_norm` | 320.18 KiB | 0.00 B —  |
| `module_0093.jit__diag` | 314.06 KiB | 312.50 KiB — output shape is \|f64[200,200]\|, maybe-live-out: |
| `module_0097.jit__diag` | 314.05 KiB | 312.50 KiB — output shape is \|f64[200,200]\|, maybe-live-out: |
