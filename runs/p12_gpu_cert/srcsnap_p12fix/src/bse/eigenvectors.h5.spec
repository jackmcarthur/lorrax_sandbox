THIS IS A DOCUMENT FOR FORTRAN ORDERED ARRAYS! YOU SHOULD INTERPRET ALL ARRAY DIMS AS BEING REVERSED
E.G. nQ FOR THE OUTERMOST DIM IN THE EIGENVECTORS DATASET
