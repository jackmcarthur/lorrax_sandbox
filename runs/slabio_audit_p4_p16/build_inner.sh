set -eu
export LORRAX_ROOT=/scratch2/08271/jackmc/slabio_audit/src_fix
export LORRAX_VENV=/work2/08271/jackmc/frontera/lorrax_env/.venv
export LORRAX_FFI_HOST_STAGE=/work2/08271/jackmc/frontera/lorrax_ffi_unified/build_host_SLABIO
...
bash /scratch2/08271/jackmc/slabio_audit/src_fix/config/frontera/build_ffi_host.sh --fresh
